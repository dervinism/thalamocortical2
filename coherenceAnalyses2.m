    ...
    parfor iCombo = 1:max([size(combosPY,1) size(combosIN,1) size(combosNRT,1) size(combosTC,1)])
        ...
        if spiking
            if iCombo <= size(combosPY,1)
                ...
                [psiRasterCx23(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx23(cell1,:), rasterCx23(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx4(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx4(cell1,:), rasterCx4(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx5(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx5(cell1,:), rasterCx5(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx6(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx6(cell1,:), rasterCx6(cell2,:));
            ...
            if iCombo <= size(combosIN,1)
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx23i(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx23i(cell1,:), rasterCx23i(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx4i(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx4i(cell1,:), rasterCx4i(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx5i(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx5i(cell1,:), rasterCx5i(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterCx6i(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterCx6i(cell1,:), rasterCx6i(cell2,:));
            ...
            if iCombo <= size(combosNRT,1)
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterNRT(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterNRT(cell1,:), rasterNRT(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterNRT2(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterNRT2(cell1,:), rasterNRT2(cell2,:));
            ...
            if iCombo <= size(combosTC,1)
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterTC(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterTC(cell1,:), rasterTC(cell2,:));
                ...
                rasterFiltNorm2 = (rasterFilt2-min(rasterFilt2))./max(rasterFilt2-min(rasterFilt2));
                [psiRasterTC2(iCombo), psi_t] = hilbertPhaseSync(rasterFiltNorm, rasterFiltNorm2, psiWindow, rasterTC2(cell1,:), rasterTC2(cell2,:));
...
if fullRun
    ...
    if voltage
        ...
        [psi2Cx23MeanAligned_i, psi2Cx23CI95Aligned_i, tStartAligned_i, tEndAligned_i,...
            ...
            psi2Cx23Mean_interictal, psi2Cx23CI95_interictal, psi2Cx23MeanFirst, psi2Cx23CI95First,...
            psi2Cx23MeanSecond, psi2Cx23CI95Second, psi2Cx23MeanThird, psi2Cx23CI95Third, psi2Cx23MeanThird10, psi2Cx23CI95Third10] = frAlign(interictalInterp, psiCx23_t, tInterpFinal);
        ...
        [psi2Cx23iMeanAligned_i, psi2Cx23iCI95Aligned_i, ~, ~,...
            ...
            psi2Cx23iMean_interictal, psi2Cx23iCI95_interictal, psi2Cx23iMeanFirst, psi2Cx23iCI95First,...
            psi2Cx23iMeanSecond, psi2Cx23iCI95Second, psi2Cx23iMeanThird, psi2Cx23iCI95Third, psi2Cx23iMeanThird10, psi2Cx23iCI95Third10] = frAlign(interictalInterp, psiCx23i_t, tInterpFinal);
        ...
        [psi2Cx4MeanAligned_i, psi2Cx4CI95Aligned_i, ~, ~,...
            ...
            psi2Cx4Mean_interictal, psi2Cx4CI95_interictal, psi2Cx4MeanFirst, psi2Cx4CI95First,...
            psi2Cx4MeanSecond, psi2Cx4CI95Second, psi2Cx4MeanThird, psi2Cx4CI95Third, psi2Cx4MeanThird10, psi2Cx4CI95Third10] = frAlign(interictalInterp, psiCx4_t, tInterpFinal);
        ...
        [psi2Cx4iMeanAligned_i, psi2Cx4iCI95Aligned_i, ~, ~,...
            ...
            psi2Cx4iMean_interictal, psi2Cx4iCI95_interictal, psi2Cx4iMeanFirst, psi2Cx4iCI95First,...
            psi2Cx4iMeanSecond, psi2Cx4iCI95Second, psi2Cx4iMeanThird, psi2Cx4iCI95Third, psi2Cx4iMeanThird10, psi2Cx4iCI95Third10] = frAlign(interictalInterp, psiCx4i_t, tInterpFinal);
        ...
        [psi2Cx5MeanAligned_i, psi2Cx5CI95Aligned_i, ~, ~,...
            ...
            psi2Cx5Mean_interictal, psi2Cx5CI95_interictal, psi2Cx5MeanFirst, psi2Cx5CI95First,...
            psi2Cx5MeanSecond, psi2Cx5CI95Second, psi2Cx5MeanThird, psi2Cx5CI95Third, psi2Cx5MeanThird10, psi2Cx5CI95Third10] = frAlign(interictalInterp, psiCx5_t, tInterpFinal);
        ...
        [psi2Cx5iMeanAligned_i, psi2Cx5iCI95Aligned_i, ~, ~,...
            ...
            psi2Cx5iMean_interictal, psi2Cx5iCI95_interictal, psi2Cx5iMeanFirst, psi2Cx5iCI95First,...
            psi2Cx5iMeanSecond, psi2Cx5iCI95Second, psi2Cx5iMeanThird, psi2Cx5iCI95Third, psi2Cx5iMeanThird10, psi2Cx5iCI95Third10] = frAlign(interictalInterp, psiCx5i_t, tInterpFinal);
        ...
        [psi2Cx6MeanAligned_i, psi2Cx6CI95Aligned_i, ~, ~,...
            ...
            psi2Cx6Mean_interictal, psi2Cx6CI95_interictal, psi2Cx6MeanFirst, psi2Cx6CI95First,...
            psi2Cx6MeanSecond, psi2Cx6CI95Second, psi2Cx6MeanThird, psi2Cx6CI95Third, psi2Cx6MeanThird10, psi2Cx6CI95Third10] = frAlign(interictalInterp, psiCx6_t, tInterpFinal);
        ...
        [psi2Cx6iMeanAligned_i, psi2Cx6iCI95Aligned_i, ~, ~,...
            ...
            psi2Cx6iMean_interictal, psi2Cx6iCI95_interictal, psi2Cx6iMeanFirst, psi2Cx6iCI95First,...
            psi2Cx6iMeanSecond, psi2Cx6iCI95Second, psi2Cx6iMeanThird, psi2Cx6iCI95Third, psi2Cx6iMeanThird10, psi2Cx6iCI95Third10] = frAlign(interictalInterp, psiCx6i_t, tInterpFinal);
        ...
        [psi2NRTMeanAligned_i, psi2NRTCI95Aligned_i, ~, ~,...
            ...
            psi2NRTMean_interictal, psi2NRTCI95_interictal, psi2NRTMeanFirst, psi2NRTCI95First,...
            psi2NRTMeanSecond, psi2NRTCI95Second, psi2NRTMeanThird, psi2NRTCI95Third, psi2NRTMeanThird10, psi2NRTCI95Third10] = frAlign(interictalInterp, psiNRT_t, tInterpFinal);
        ...
        [psi2NRT2MeanAligned_i, psi2NRT2CI95Aligned_i, ~, ~,...
            ...
            psi2NRT2Mean_interictal, psi2NRT2CI95_interictal, psi2NRT2MeanFirst, psi2NRT2CI95First,...
            psi2NRT2MeanSecond, psi2NRT2CI95Second, psi2NRT2MeanThird, psi2NRT2CI95Third, psi2NRT2MeanThird10, psi2NRT2CI95Third10] = frAlign(interictalInterp, psiNRT2_t, tInterpFinal);
        ...
        [psi2TCMeanAligned_i, psi2TCCI95Aligned_i, ~, ~,...
            ...
            psi2TCMean_interictal, psi2TCCI95_interictal, psi2TCMeanFirst, psi2TCCI95First,...
            psi2TCMeanSecond, psi2TCCI95Second, psi2TCMeanThird, psi2TCCI95Third, psi2TCMeanThird10, psi2TCCI95Third10] = frAlign(interictalInterp, psiTC_t, tInterpFinal);
        ...
        [psi2TC2MeanAligned_i, psi2TC2CI95Aligned_i, ~, ~,...
            ...
            psi2TC2Mean_interictal, psi2TC2CI95_interictal, psi2TC2MeanFirst, psi2TC2CI95First,...
            psi2TC2MeanSecond, psi2TC2CI95Second, psi2TC2MeanThird, psi2TC2CI95Third, psi2TC2MeanThird10, psi2TC2CI95Third10] = frAlign(interictalInterp, psiTC2_t, tInterpFinal);
    ...
    if spiking
        ...
        [psi2RasterCx23MeanAligned_i, psi2RasterCx23CI95Aligned_i, tStartAligned_i, tEndAligned_i,...
            ...
            psi2RasterCx23Mean_interictal, psi2RasterCx23CI95_interictal, psi2RasterCx23MeanFirst, psi2RasterCx23CI95First,...
            psi2RasterCx23MeanSecond, psi2RasterCx23CI95Second, psi2RasterCx23MeanThird, psi2RasterCx23CI95Third, psi2RasterCx23MeanThird10, psi2RasterCx23CI95Third10] = frAlign(interictalInterp, psiRasterCx23_t, tInterpFinal);
        ...
        [psi2RasterCx23iMeanAligned_i, psi2RasterCx23iCI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx23iMean_interictal, psi2RasterCx23iCI95_interictal, psi2RasterCx23iMeanFirst, psi2RasterCx23iCI95First,...
            psi2RasterCx23iMeanSecond, psi2RasterCx23iCI95Second, psi2RasterCx23iMeanThird, psi2RasterCx23iCI95Third, psi2RasterCx23iMeanThird10, psi2RasterCx23iCI95Third10] = frAlign(interictalInterp, psiRasterCx23i_t, tInterpFinal);
        ...
        [psi2RasterCx4MeanAligned_i, psi2RasterCx4CI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx4Mean_interictal, psi2RasterCx4CI95_interictal, psi2RasterCx4MeanFirst, psi2RasterCx4CI95First,...
            psi2RasterCx4MeanSecond, psi2RasterCx4CI95Second, psi2RasterCx4MeanThird, psi2RasterCx4CI95Third, psi2RasterCx4MeanThird10, psi2RasterCx4CI95Third10] = frAlign(interictalInterp, psiRasterCx4_t, tInterpFinal);
        ...
        [psi2RasterCx4iMeanAligned_i, psi2RasterCx4iCI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx4iMean_interictal, psi2RasterCx4iCI95_interictal, psi2RasterCx4iMeanFirst, psi2RasterCx4iCI95First,...
            psi2RasterCx4iMeanSecond, psi2RasterCx4iCI95Second, psi2RasterCx4iMeanThird, psi2RasterCx4iCI95Third, psi2RasterCx4iMeanThird10, psi2RasterCx4iCI95Third10] = frAlign(interictalInterp, psiRasterCx4i_t, tInterpFinal);
        ...
        [psi2RasterCx5MeanAligned_i, psi2RasterCx5CI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx5Mean_interictal, psi2RasterCx5CI95_interictal, psi2RasterCx5MeanFirst, psi2RasterCx5CI95First,...
            psi2RasterCx5MeanSecond, psi2RasterCx5CI95Second, psi2RasterCx5MeanThird, psi2RasterCx5CI95Third, psi2RasterCx5MeanThird10, psi2RasterCx5CI95Third10] = frAlign(interictalInterp, psiRasterCx5_t, tInterpFinal);
        ...
        [psi2RasterCx5iMeanAligned_i, psi2RasterCx5iCI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx5iMean_interictal, psi2RasterCx5iCI95_interictal, psi2RasterCx5iMeanFirst, psi2RasterCx5iCI95First,...
            psi2RasterCx5iMeanSecond, psi2RasterCx5iCI95Second, psi2RasterCx5iMeanThird, psi2RasterCx5iCI95Third, psi2RasterCx5iMeanThird10, psi2RasterCx5iCI95Third10] = frAlign(interictalInterp, psiRasterCx5i_t, tInterpFinal);
        ...
        [psi2RasterCx6MeanAligned_i, psi2RasterCx6CI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx6Mean_interictal, psi2RasterCx6CI95_interictal, psi2RasterCx6MeanFirst, psi2RasterCx6CI95First,...
            psi2RasterCx6MeanSecond, psi2RasterCx6CI95Second, psi2RasterCx6MeanThird, psi2RasterCx6CI95Third, psi2RasterCx6MeanThird10, psi2RasterCx6CI95Third10] = frAlign(interictalInterp, psiRasterCx6_t, tInterpFinal);
        ...
        [psi2RasterCx6iMeanAligned_i, psi2RasterCx6iCI95Aligned_i, ~, ~,...
            ...
            psi2RasterCx6iMean_interictal, psi2RasterCx6iCI95_interictal, psi2RasterCx6iMeanFirst, psi2RasterCx6iCI95First,...
            psi2RasterCx6iMeanSecond, psi2RasterCx6iCI95Second, psi2RasterCx6iMeanThird, psi2RasterCx6iCI95Third, psi2RasterCx6iMeanThird10, psi2RasterCx6iCI95Third10] = frAlign(interictalInterp, psiRasterCx6i_t, tInterpFinal);
        ...
        [psi2RasterNRTMeanAligned_i, psi2RasterNRTCI95Aligned_i, ~, ~,...
            ...
            psi2RasterNRTMean_interictal, psi2RasterNRTCI95_interictal, psi2RasterNRTMeanFirst, psi2RasterNRTCI95First,...
            psi2RasterNRTMeanSecond, psi2RasterNRTCI95Second, psi2RasterNRTMeanThird, psi2RasterNRTCI95Third, psi2RasterNRTMeanThird10, psi2RasterNRTCI95Third10] = frAlign(interictalInterp, psiRasterNRT_t, tInterpFinal);
        ...
        [psi2RasterNRT2MeanAligned_i, psi2RasterNRT2CI95Aligned_i, ~, ~,...
            ...
            psi2RasterNRT2Mean_interictal, psi2RasterNRT2CI95_interictal, psi2RasterNRT2MeanFirst, psi2RasterNRT2CI95First,...
            psi2RasterNRT2MeanSecond, psi2RasterNRT2CI95Second, psi2RasterNRT2MeanThird, psi2RasterNRT2CI95Third, psi2RasterNRT2MeanThird10, psi2RasterNRT2CI95Third10] = frAlign(interictalInterp, psiRasterNRT2_t, tInterpFinal);
        ...
        [psi2RasterTCMeanAligned_i, psi2RasterTCCI95Aligned_i, ~, ~,...
            ...
            psi2RasterTCMean_interictal, psi2RasterTCCI95_interictal, psi2RasterTCMeanFirst, psi2RasterTCCI95First,...
            psi2RasterTCMeanSecond, psi2RasterTCCI95Second, psi2RasterTCMeanThird, psi2RasterTCCI95Third, psi2RasterTCMeanThird10, psi2RasterTCCI95Third10] = frAlign(interictalInterp, psiRasterTC_t, tInterpFinal);
        ...
        [psi2RasterTC2MeanAligned_i, psi2RasterTC2CI95Aligned_i, ~, ~,...
            ...
            psi2RasterTC2Mean_interictal, psi2RasterTC2CI95_interictal, psi2RasterTC2MeanFirst, psi2RasterTC2CI95First,...
            psi2RasterTC2MeanSecond, psi2RasterTC2CI95Second, psi2RasterTC2MeanThird, psi2RasterTC2CI95Third, psi2RasterTC2MeanThird10, psi2RasterTC2CI95Third10] = frAlign(interictalInterp, psiRasterTC2_t, tInterpFinal);
...
if fullRun
    ...
    if voltage && ~spiking
        save('psiData2.mat', 'dt','t','dtInterpInit','dtInterpFinal','tInterpInit','tInterpFinal',...
            ...
            'psi2Cx23Mean_SWDs','psi2Cx23CI95_SWDs','psi2Cx23iMean_SWDs','psi2Cx23iCI95_SWDs',...
            'psi2Cx4Mean_SWDs','psi2Cx4CI95_SWDs','psi2Cx4iMean_SWDs','psi2Cx4iCI95_SWDs',...
            'psi2Cx5Mean_SWDs','psi2Cx5CI95_SWDs','psi2Cx5iMean_SWDs','psi2Cx5iCI95_SWDs',...
            'psi2Cx6Mean_SWDs','psi2Cx6CI95_SWDs','psi2Cx6iMean_SWDs','psi2Cx6iCI95_SWDs',...
            'psi2NRTMean_SWDs','psi2NRTCI95_SWDs','psi2NRT2Mean_SWDs','psi2NRT2CI95_SWDs',...
            'psi2TCMean_SWDs','psi2TCCI95_SWDs','psi2TC2Mean_SWDs','psi2TC2CI95_SWDs',...
            ...
            'psi2Cx23Mean_interictal','psi2Cx23CI95_interictal','psi2Cx23iMean_interictal','psi2Cx23iCI95_interictal',...
            'psi2Cx4Mean_interictal','psi2Cx4CI95_interictal','psi2Cx4iMean_interictal','psi2Cx4iCI95_interictal',...
            'psi2Cx5Mean_interictal','psi2Cx5CI95_interictal','psi2Cx5iMean_interictal','psi2Cx5iCI95_interictal',...
            'psi2Cx6Mean_interictal','psi2Cx6CI95_interictal','psi2Cx6iMean_interictal','psi2Cx6iCI95_interictal',...
            'psi2NRTMean_interictal','psi2NRTCI95_interictal','psi2NRT2Mean_interictal','psi2NRT2CI95_interictal',...
            'psi2TCMean_interictal','psi2TCCI95_interictal','psi2TC2Mean_interictal','psi2TC2CI95_interictal',...
            'psi2Cx23MeanFirst','psi2Cx23CI95First','psi2Cx23iMeanFirst','psi2Cx23iCI95First',...
            'psi2Cx4MeanFirst','psi2Cx4CI95First','psi2Cx4iMeanFirst','psi2Cx4iCI95First',...
            'psi2Cx5MeanFirst','psi2Cx5CI95First','psi2Cx5iMeanFirst','psi2Cx5iCI95First',...
            'psi2Cx6MeanFirst','psi2Cx6CI95First','psi2Cx6iMeanFirst','psi2Cx6iCI95First',...
            'psi2NRTMeanFirst','psi2NRTCI95First','psi2NRT2MeanFirst','psi2NRT2CI95First',...
            'psi2TCMeanFirst','psi2TCCI95First','psi2TC2MeanFirst','psi2TC2CI95First',...
            'psi2Cx23MeanSecond','psi2Cx23CI95Second','psi2Cx23iMeanSecond','psi2Cx23iCI95Second',...
            'psi2Cx4MeanSecond','psi2Cx4CI95Second','psi2Cx4iMeanSecond','psi2Cx4iCI95Second',...
            'psi2Cx5MeanSecond','psi2Cx5CI95Second','psi2Cx5iMeanSecond','psi2Cx5iCI95Second',...
            'psi2Cx6MeanSecond','psi2Cx6CI95Second','psi2Cx6iMeanSecond','psi2Cx6iCI95Second',...
            'psi2NRTMeanSecond','psi2NRTCI95Second','psi2NRT2MeanSecond','psi2NRT2CI95Second',...
            'psi2TCMeanSecond','psi2TCCI95Second','psi2TC2MeanSecond','psi2TC2CI95Second',...
            'psi2Cx23MeanThird','psi2Cx23CI95Third','psi2Cx23iMeanThird','psi2Cx23iCI95Third',...
            'psi2Cx4MeanThird','psi2Cx4CI95Third','psi2Cx4iMeanThird','psi2Cx4iCI95Third',...
            'psi2Cx5MeanThird','psi2Cx5CI95Third','psi2Cx5iMeanThird','psi2Cx5iCI95Third',...
            'psi2Cx6MeanThird','psi2Cx6CI95Third','psi2Cx6iMeanThird','psi2Cx6iCI95Third',...
            'psi2NRTMeanThird','psi2NRTCI95Third','psi2NRT2MeanThird','psi2NRT2CI95Third',...
            'psi2TCMeanThird','psi2TCCI95Third','psi2TC2MeanThird','psi2TC2CI95Third',...
            'psi2Cx23MeanThird10','psi2Cx23CI95Third10','psi2Cx23iMeanThird10','psi2Cx23iCI95Third10',...
            'psi2Cx4MeanThird10','psi2Cx4CI95Third10','psi2Cx4iMeanThird10','psi2Cx4iCI95Third10',...
            'psi2Cx5MeanThird10','psi2Cx5CI95Third10','psi2Cx5iMeanThird10','psi2Cx5iCI95Third10',...
            'psi2Cx6MeanThird10','psi2Cx6CI95Third10','psi2Cx6iMeanThird10','psi2Cx6iCI95Third10',...
            'psi2NRTMeanThird10','psi2NRTCI95Third10','psi2NRT2MeanThird10','psi2NRT2CI95Third10',...
            'psi2TCMeanThird10','psi2TCCI95Third10','psi2TC2MeanThird10','psi2TC2CI95Third10',...
    ...
    elseif ~voltage && spiking
        save('psiData2.mat', 'dt','t','dtInterpInit','dtInterpFinal','tInterpInit','tInterpFinal',...
            ...
            'psi2RasterCx23Mean_SWDs','psi2RasterCx23CI95_SWDs','psi2RasterCx23iMean_SWDs','psi2RasterCx23iCI95_SWDs',...
            'psi2RasterCx4Mean_SWDs','psi2RasterCx4CI95_SWDs','psi2RasterCx4iMean_SWDs','psi2RasterCx4iCI95_SWDs',...
            'psi2RasterCx5Mean_SWDs','psi2RasterCx5CI95_SWDs','psi2RasterCx5iMean_SWDs','psi2RasterCx5iCI95_SWDs',...
            'psi2RasterCx6Mean_SWDs','psi2RasterCx6CI95_SWDs','psi2RasterCx6iMean_SWDs','psi2RasterCx6iCI95_SWDs',...
            'psi2RasterNRTMean_SWDs','psi2RasterNRTCI95_SWDs','psi2RasterNRT2Mean_SWDs','psi2RasterNRT2CI95_SWDs',...
            'psi2RasterTCMean_SWDs','psi2RasterTCCI95_SWDs','psi2RasterTC2Mean_SWDs','psi2RasterTC2CI95_SWDs',...
            ...
            'psi2RasterCx23Mean_interictal','psi2RasterCx23CI95_interictal','psi2RasterCx23iMean_interictal','psi2RasterCx23iCI95_interictal',...
            'psi2RasterCx4Mean_interictal','psi2RasterCx4CI95_interictal','psi2RasterCx4iMean_interictal','psi2RasterCx4iCI95_interictal',...
            'psi2RasterCx5Mean_interictal','psi2RasterCx5CI95_interictal','psi2RasterCx5iMean_interictal','psi2RasterCx5iCI95_interictal',...
            'psi2RasterCx6Mean_interictal','psi2RasterCx6CI95_interictal','psi2RasterCx6iMean_interictal','psi2RasterCx6iCI95_interictal',...
            'psi2RasterNRTMean_interictal','psi2RasterNRTCI95_interictal','psi2RasterNRT2Mean_interictal','psi2RasterNRT2CI95_interictal',...
            'psi2RasterTCMean_interictal','psi2RasterTCCI95_interictal','psi2RasterTC2Mean_interictal','psi2RasterTC2CI95_interictal',...
            'psi2RasterCx23MeanFirst','psi2RasterCx23CI95First','psi2RasterCx23iMeanFirst','psi2RasterCx23iCI95First',...
            'psi2RasterCx4MeanFirst','psi2RasterCx4CI95First','psi2RasterCx4iMeanFirst','psi2RasterCx4iCI95First',...
            'psi2RasterCx5MeanFirst','psi2RasterCx5CI95First','psi2RasterCx5iMeanFirst','psi2RasterCx5iCI95First',...
            'psi2RasterCx6MeanFirst','psi2RasterCx6CI95First','psi2RasterCx6iMeanFirst','psi2RasterCx6iCI95First',...
            'psi2RasterNRTMeanFirst','psi2RasterNRTCI95First','psi2RasterNRT2MeanFirst','psi2RasterNRT2CI95First',...
            'psi2RasterTCMeanFirst','psi2RasterTCCI95First','psi2RasterTC2MeanFirst','psi2RasterTC2CI95First',...
            'psi2RasterCx23MeanSecond','psi2RasterCx23CI95Second','psi2RasterCx23iMeanSecond','psi2RasterCx23iCI95Second',...
            'psi2RasterCx4MeanSecond','psi2RasterCx4CI95Second','psi2RasterCx4iMeanSecond','psi2RasterCx4iCI95Second',...
            'psi2RasterCx5MeanSecond','psi2RasterCx5CI95Second','psi2RasterCx5iMeanSecond','psi2RasterCx5iCI95Second',...
            'psi2RasterCx6MeanSecond','psi2RasterCx6CI95Second','psi2RasterCx6iMeanSecond','psi2RasterCx6iCI95Second',...
            'psi2RasterNRTMeanSecond','psi2RasterNRTCI95Second','psi2RasterNRT2MeanSecond','psi2RasterNRT2CI95Second',...
            'psi2RasterTCMeanSecond','psi2RasterTCCI95Second','psi2RasterTC2MeanSecond','psi2RasterTC2CI95Second',...
            'psi2RasterCx23MeanThird','psi2RasterCx23CI95Third','psi2RasterCx23iMeanThird','psi2RasterCx23iCI95Third',...
            'psi2RasterCx4MeanThird','psi2RasterCx4CI95Third','psi2RasterCx4iMeanThird','psi2RasterCx4iCI95Third',...
            'psi2RasterCx5MeanThird','psi2RasterCx5CI95Third','psi2RasterCx5iMeanThird','psi2RasterCx5iCI95Third',...
            'psi2RasterCx6MeanThird','psi2RasterCx6CI95Third','psi2RasterCx6iMeanThird','psi2RasterCx6iCI95Third',...
            'psi2RasterNRTMeanThird','psi2RasterNRTCI95Third','psi2RasterNRT2MeanThird','psi2RasterNRT2CI95Third',...
            'psi2RasterTCMeanThird','psi2RasterTCCI95Third','psi2RasterTC2MeanThird','psi2RasterTC2CI95Third',...
            'psi2RasterCx23MeanThird10','psi2RasterCx23CI95Third10','psi2RasterCx23iMeanThird10','psi2RasterCx23iCI95Third10',...
            'psi2RasterCx4MeanThird10','psi2RasterCx4CI95Third10','psi2RasterCx4iMeanThird10','psi2RasterCx4iCI95Third10',...
            'psi2RasterCx5MeanThird10','psi2RasterCx5CI95Third10','psi2RasterCx5iMeanThird10','psi2RasterCx5iCI95Third10',...
            'psi2RasterCx6MeanThird10','psi2RasterCx6CI95Third10','psi2RasterCx6iMeanThird10','psi2RasterCx6iCI95Third10',...
            'psi2RasterNRTMeanThird10','psi2RasterNRTCI95Third10','psi2RasterNRT2MeanThird10','psi2RasterNRT2CI95Third10',...
            'psi2RasterTCMeanThird10','psi2RasterTCCI95Third10','psi2RasterTC2MeanThird10','psi2RasterTC2CI95Third10',...
