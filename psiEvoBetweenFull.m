...
barCount = barCount + 1;
bar4 = mean(psi2RasterCx4toTCMeanSecond,'omitnan')-mean(psi2RasterCx4toTCMeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar4, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar5 = mean(psi2RasterCx4toTCMeanThird10,'omitnan')-mean(psi2RasterCx4toTCMeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar5, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar6 = mean(psi2RasterCx4toTCMean_SWDs,'omitnan')-mean(psi2RasterCx4toTCMeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar6, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('Cx4');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar7 = mean(psi2RasterCx4toTC2MeanSecond,'omitnan')-mean(psi2RasterCx4toTC2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar7, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar8 = mean(psi2RasterCx4toTC2MeanThird10,'omitnan')-mean(psi2RasterCx4toTC2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar8, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar9 = mean(psi2RasterCx4toTC2Mean_SWDs,'omitnan')-mean(psi2RasterCx4toTC2MeanThird10,'omitnan');
...
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar19 = mean(psi2RasterCx5toTCMeanSecond,'omitnan')-mean(psi2RasterCx5toTCMeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar19, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar20 = mean(psi2RasterCx5toTCMeanThird10,'omitnan')-mean(psi2RasterCx5toTCMeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar20, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar21 = mean(psi2RasterCx5toTCMean_SWDs,'omitnan')-mean(psi2RasterCx5toTCMeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar21, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('Cx5');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar22 = mean(psi2RasterCx5toTC2MeanSecond,'omitnan')-mean(psi2RasterCx5toTC2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar22, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar23 = mean(psi2RasterCx5toTC2MeanThird10,'omitnan')-mean(psi2RasterCx5toTC2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar23, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar24 = mean(psi2RasterCx5toTC2Mean_SWDs,'omitnan')-mean(psi2RasterCx5toTC2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar24, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('Cx5');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar25 = mean(psi2RasterCx5toNRTMeanSecond,'omitnan')-mean(psi2RasterCx5toNRTMeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar25, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar26 = mean(psi2RasterCx5toNRTMeanThird10,'omitnan')-mean(psi2RasterCx5toNRTMeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar26, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar27 = mean(psi2RasterCx5toNRTMean_SWDs,'omitnan')-mean(psi2RasterCx5toNRTMeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar27, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('Cx5');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar28 = mean(psi2RasterCx5toNRT2MeanSecond,'omitnan')-mean(psi2RasterCx5toNRT2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar28, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar29 = mean(psi2RasterCx5toNRT2MeanThird10,'omitnan')-mean(psi2RasterCx5toNRT2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar29, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar30 = mean(psi2RasterCx5toNRT2Mean_SWDs,'omitnan')-mean(psi2RasterCx5toNRT2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar30, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('NRT');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar31 = mean(psi2RasterNRTtoTCMeanSecond,'omitnan')-mean(psi2RasterNRTtoTCMeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar31, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar32 = mean(psi2RasterNRTtoTCMeanThird10,'omitnan')-mean(psi2RasterNRTtoTCMeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar32, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar33 = mean(psi2RasterNRTtoTCMean_SWDs,'omitnan')-mean(psi2RasterNRTtoTCMeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar33, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('NRT');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar34 = mean(psi2RasterNRTtoTC2MeanSecond,'omitnan')-mean(psi2RasterNRTtoTC2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar34, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar35 = mean(psi2RasterNRTtoTC2MeanThird10,'omitnan')-mean(psi2RasterNRTtoTC2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar35, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar36 = mean(psi2RasterNRTtoTC2Mean_SWDs,'omitnan')-mean(psi2RasterNRTtoTC2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar36, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('NRT2');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar37 = mean(psi2RasterNRT2toTCMeanSecond,'omitnan')-mean(psi2RasterNRT2toTCMeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar37, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar38 = mean(psi2RasterNRT2toTCMeanThird10,'omitnan')-mean(psi2RasterNRT2toTCMeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar38, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar39 = mean(psi2RasterNRT2toTCMean_SWDs,'omitnan')-mean(psi2RasterNRT2toTCMeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar39, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('NRT2');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar40 = mean(psi2RasterNRT2toTC2MeanSecond,'omitnan')-mean(psi2RasterNRT2toTC2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar40, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar41 = mean(psi2RasterNRT2toTC2MeanThird10,'omitnan')-mean(psi2RasterNRT2toTC2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar41, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar42 = mean(psi2RasterNRT2toTC2Mean_SWDs,'omitnan')-mean(psi2RasterNRT2toTC2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar42, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('NRT');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar43 = mean(psi2RasterNRTtoNRT2MeanSecond,'omitnan')-mean(psi2RasterNRTtoNRT2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar43, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar44 = mean(psi2RasterNRTtoNRT2MeanThird10,'omitnan')-mean(psi2RasterNRTtoNRT2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar44, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar45 = mean(psi2RasterNRTtoNRT2Mean_SWDs,'omitnan')-mean(psi2RasterNRTtoNRT2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar45, 'FaceColor',colour, 'EdgeColor',colour);

colour = cellColour('TC');
barGroupCount = barGroupCount + 1;
barCount = barCount + 1;
bar46 = mean(psi2RasterTCtoTC2MeanSecond,'omitnan')-mean(psi2RasterTCtoTC2MeanFirst,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar46, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar47 = mean(psi2RasterTCtoTC2MeanThird10,'omitnan')-mean(psi2RasterTCtoTC2MeanSecond,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar47, 'FaceColor',colour, 'EdgeColor',colour);
barCount = barCount + 1;
bar48 = mean(psi2RasterTCtoTC2Mean_SWDs,'omitnan')-mean(psi2RasterTCtoTC2MeanThird10,'omitnan');
bar(barCount+(barGroupCount-1)*gap, bar48, 'FaceColor',colour, 'EdgeColor',colour);
...
% data = [bar1 bar2 bar3 bar4 bar5 bar6 bar7 bar8 bar9 bar10 bar11 bar12 bar13 bar14 bar15 bar16...
%         bar17 bar18 bar19 bar20 bar21 bar22 bar23 bar24 bar25 bar26 bar27 bar28 bar29 bar30];
...
ax1 = axesProperties({}, 1, 'normal', 'off', 'w', 'Arial', 50, 4/3, 2, [0.003 0.003], 'out', 'on', 'k', {}, [],...
    [gaps1 gaps1(end)+4], 'on', 'k', {''}, ylim, [-0.02 0 0.02 0.04]);
%ax1.XTickLabel = {'','','','','','','','','','','','','','','',''};
ax1.XTickLabel = {'4-4i','4-TC','4-TC2','4-NRT','4-NRT2','5-5i','5-TC','5-TC2','5-NRT','5-NRT2','NRT-TC','NRT-TC2','NRT2-TC','NRT2-TC2','NRT-NRT2','TC-TC2'};
...
savefig(gcf, 'psiEvoBetweenFull.fig', 'compact');
%exportFig(gcf, 'psiEvoBetweenFull.png','-dpng','-r300', paperSize);
%exportFig(gcf, 'psiEvoBetweenFull'.tif','-dtiffnocompression','-r300', paperSize);
exportFig(gcf, 'psiEvoBetweenFull.eps','-depsc','-r1200', paperSize);