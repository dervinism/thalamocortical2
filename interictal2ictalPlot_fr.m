...
for iPair = 1:numel(dataPairs)
    ...
    dataOI_1 = frMeanAlignedScaled_i(:,indsOI);
    dataOICI95_1 = frCI95AlignedScaled_i(:,indsOI);
    
    %load(dataPairs{iPair}{2})
    indsOI = tStartAlignedScaled >= 0 & tEndAlignedScaled <= 0;
    dataOI_2 = frMeanAlignedScaled(:,indsOI);
    dataOICI95_2 = frCI95AlignedScaled(:,indsOI);
    ...
    savefig(gcf, 'fr_evo.fig', 'compact');
    ...
    exportFig(gcf, 'fr_evo.eps','-depsc','-r1200', paperSize);
end