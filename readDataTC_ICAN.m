...
f1 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f2 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f3 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f4 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f5 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f6 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f7 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
f8 = figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
...
figure('Units', 'normalized', 'Position', [0,.01, .99, .89]);
