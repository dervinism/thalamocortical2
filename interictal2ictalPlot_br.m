...
for iPair = 1:numel(dataPairs)
    ...
    dataOI_1 = brMeanAlignedScaled_i(:,indsOI);
    dataOICI95_1 = brCI95AlignedScaled_i(:,indsOI);
    
    %load(dataPairs{iPair}{2})
    indsOI = tStartAlignedScaled >= 0 & tEndAlignedScaled <= 0;
    dataOI_2 = brMeanAlignedScaled(:,indsOI);
    dataOICI95_2 = brCI95AlignedScaled(:,indsOI);
    ...
    savefig(gcf, 'br_evo.fig', 'compact');
    ...
    exportFig(gcf, 'br_evo.eps','-depsc','-r1200', paperSize);
end