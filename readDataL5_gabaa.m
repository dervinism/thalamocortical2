...
for i = 2
    ...
    t1000_1100 = t - 1000;
    t1000_1100(t1000_1100 < 0) = 0;
    ind1000 = find(t1000_1100, 1);
    t1000_1100 = t - 1100;
    t1000_1100(t1000_1100 < 0) = 0;
    ind1100 = find(t1000_1100, 1);
    t1000_1100 = t(ind1000:ind1100);
    i1000_1100 = iS(ind1000:ind1100);
    i1000_1100 = i1000_1100 - i1000_1100(1);
    indStart = ind1000 + find(i1000_1100, 1) - 1;
    tStart = t(indStart);
    
    [maxI, indMax] = max(i1000_1100);
    amplitude = 1000*maxI %#ok<NOPTS>
    indMax = ind1000 + indMax - 1;
    tMax = t(indMax);
    i1000_1100RT = i1000_1100 - 0.1*maxI; 
    i1000_1100RT(i1000_1100RT < 0) = 0;
    ind10RT = ind1000 + find(i1000_1100RT, 1) - 1;
    t10RT = t(ind10RT);
    
    i1000_1100RT = i1000_1100 - 0.9*maxI;
    i1000_1100RT(i1000_1100RT < 0) = 0;
    ind90RT = ind1000 + find(i1000_1100RT, 1) - 1;
    t90RT = t(ind90RT);
    RT10_90 = t90RT - t10RT %#ok<NOPTS>
    
    i1000_1100 = iS(ind1000:ind1100);
    iDecay = iS(indMax:end) - i1000_1100(1);
    iDecay = iDecay - maxI/exp(1);
    iDecay(iDecay < 0) = 0;
    indE = indMax + find(iDecay, 1, 'last');
    tE = t(indE);
