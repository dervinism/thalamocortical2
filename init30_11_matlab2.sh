...
#SBATCH --nodelist=f03-11
#SBATCH --job-name=THALAMOCORTICAL  # name the job           
#SBATCH --nodes=1                   # number of nodes to use
#SBATCH --ntasks=30                 # total number of tasks (preocesses)
#SBATCH --mem-per-cpu=16093         # in megabytes, unless unit explicitly stated
...
time matlab < coherenceAnalyses2.m